...
trait ControllerTrait
{
    ...
    {
        if (!isset($this->router) || !$this->router instanceof RouterInterface) {
            throw new \LogicException('You can not use the generateUrl method if router is not injected.');
        }
    ...
    {
        if (!isset($this->requestStack) || !$this->requestStack instanceof RequestStack) {
            throw new \LogicException('You can not use the generateUrl method if router is not injected.');
        }

        if (!isset($this->httpKernel) || !$this->httpKernel instanceof RequestStack) {
            throw new \LogicException('You can not use the generateUrl method if router is not injected.');
        }
    ...
    {
        if (!isset($this->authorizationChecker) || !$this->authorizationChecker instanceof AuthorizationCheckerInterface) {
